...
class RegistroPaciente(models.Model):
    ...
    nombre_pais = models.ForeignKey('configuraciones.Pais', on_delete=models.PROTECT, db_index=True)
    nombre_estado = models.ForeignKey('configuraciones.Estado', on_delete=models.PROTECT, db_index=True)
    nombre_municipio = models.ForeignKey('configuraciones.Municipio', on_delete=models.PROTECT, db_index=True)
    nombre_parroquia = models.ForeignKey('configuraciones.Parroquia', on_delete=models.PROTECT, db_index=True)
    nombre_ciudad = models.ForeignKey('configuraciones.Ciudad', on_delete=models.PROTECT, db_index=True)
