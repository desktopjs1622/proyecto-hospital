    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ciudad', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='configuraciones.Ciudad')),
                ...
                ('pais', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='configuraciones.Pais')),
                ('parroquia', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='configuraciones.Parroquia')),
            ],
            options={
